 ...
 */
export function convertXMLToBlob(xml, type) {
    var serializedXML = '<?xml version="1.0" encoding="UTF-8"?>' + serialize(xml);
...
export function serialize(element) {
    ...
    var minimalString = serializer.serializeToString(element);

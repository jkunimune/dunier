...
var Disc = /** @class */ (function (_super) {
    ...
    function Disc(radius, effectiveObliquity, hasDayNightCycle, aspectRatio) {
        ...
        var _this = _super.call(this, Math.atan(1 / aspectRatio), Math.PI / 2, hasDayNightCycle) || this;
        _this.radius = radius;
    ...
    Disc.prototype.isFlat = function () {
        return true;
    };
    Disc.prototype.computeEdgeVertexLocation = function (tileL, tileR) {
        ...
        var vx = tileL.pos.y - tileR.pos.y;
        var vy = tileR.pos.x - tileL.pos.x;
        var v2 = vx * vx + vy * vy;

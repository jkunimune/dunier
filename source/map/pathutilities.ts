 ...
 * @param φMin the lower bound of the latitude range
 * @param λMin the lower bound of the latitude range
 * @param segments the jeograffickal imputs in absolute coordinates
 * @returns the relative outputs in transformed coordinates
 */
export function adjustInputToDomain(φMin: number, λMin: number, segments: PathSegment[]): PathSegment[] {

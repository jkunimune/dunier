...
describe("offset()", () => {
	test("positive", () => {
		...
		expect(offset(path, 3)).toEqual([
			...
			{type: 'A', args: [3, 3, 0, 0, 1, 4, 8]},
			{type: 'L', args: [4, 2]},
			{type: 'A', args: [2, 2, 0, 0, 1, 2, 4]},
			{type: 'L', args: [5, 4]},
			{type: 'A', args: [1, 1, 0, 0, 1, 6, 5]},
			{type: 'L', args: [6, 8]},
			{type: 'A', args: [3, 3, 0, 0, 1, 9, 5]},
	...
	test("negative", () => {
		...
		expect(offset(path, -1)).toEqual([
			{type: 'M', args: [1, 0]},
			{type: 'L', args: [1, 3]},
			{type: 'A', args: [1, 1, 0, 0, 0, 0, 2]},
			{type: 'L', args: [3, 2]},
			{type: 'A', args: [1, 1, 0, 0, 0, 2, 3]},
			{type: 'L', args: [2, 0]},
			{type: 'A', args: [1, 1, 0, 0, 0, 3, 1]},
			{type: 'L', args: [0, 1]},
